...
-- insert
INSERT INTO USERS (USERID, USERNAME, MAILADDRESS, PASSWORD, IS_WITHDRAWAL)
	VALUES ('U0000', 'Admin', 'admin@swack.com', 'swack0000', FALSE);
INSERT INTO USERS (USERID, USERNAME, MAILADDRESS, PASSWORD, IS_WITHDRAWAL)
	VALUES ('U0001', '情報太郎', 'taro@swack.com', 'swack0001', FALSE);
INSERT INTO USERS (USERID, USERNAME, MAILADDRESS, PASSWORD, IS_WITHDRAWAL)
	VALUES ('U0002', '情報花子', 'hanako@swack.com', 'swack0002', FALSE);
INSERT INTO USERS (USERID, USERNAME, MAILADDRESS, PASSWORD, IS_WITHDRAWAL)
	VALUES ('U0003', '情報次郎', 'jiro@swack.com', 'swack0003', FALSE);
INSERT INTO USERS (USERID, USERNAME, MAILADDRESS, PASSWORD, IS_WITHDRAWAL)
	VALUES ('U0004', 'a', 'a@a', 'a', FALSE);
